...
* **[Receipt Downloader](Downloader/)**
    A client-side JavaScript utility designed to _extract and archive_ your Costco in-warehouse receipts, saving the raw data in a standardized JSON format file.
